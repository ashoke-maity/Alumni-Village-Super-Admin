...
function DeveloperSettings() {
  ...
  const handleRemoveProfileImage = async () => {
    ...
    try {
      const token = localStorage.getItem("developerAuthToken");
      await axios.delete(
        `${import.meta.env.VITE_DEVELOPER_API_URL}/developer/profile-image`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleLogout = () => {
    ...
    setTimeout(() => {
      localStorage.clear();
      navigate(`${import.meta.env.VITE_DEVELOPER_ROUTE}/developer/login`);
    }, 1000);
  };
  ...
  const handleProfileSave = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_DEVELOPER_API_URL}/developer/update-profile`,
        formData,
        {
          headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_DEVELOPER_API_URL}/developer/change-password`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      <main className="w-full px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="settings-container max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="relative">
                ...
                {profile.ProfileImage && (
                  <button
                    ...
                    className="absolute top-1 right-1 bg-blue-600 hover:bg-red-700 text-white rounded-full p-1 opacity-80 hover:opacity-100 transition"
